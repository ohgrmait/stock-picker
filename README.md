...
## About
`sub-strings` is a classic "intro to programming problem" wherein the method `stock_picker(stock_prices)` takes in an array of stock prices and returns a pair of days representing the best day to buy and the best day to sell.[^1]
